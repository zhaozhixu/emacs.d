(custom-set-variables
 ...
 '(dired-omit-extensions
   '(".o" "~" ".bin" ".lbin" ".ln" ".blg" ".bbl" ".elc" ".lof" ".glo"
     ".idx" ".lot" ".svn/" ".hg/" ".git/" ".bzr/" "CVS/" "_darcs/"
     "_MTN/" ".fmt" ".tfm" ".class" ".fas" ".lib" ".mem" ".x86f"
 ...
 '(ibuffer-saved-filter-groups
   '(("perl" ("Perl" (used-mode . cperl-mode)))
     ...
     ("c" ("C" (used-mode . c-mode) (used-mode . c-mode)))
     ("C" ("C" (used-mode . c-mode)))
     ("tex-ve" ("Verilog" (used-mode . verilog-mode))
      ("LaTeX" (used-mode . latex-mode)))
     ("tex" ("LaTeX" (used-mode . latex-mode)))
     ("verilog" ("Verilog" (used-mode . verilog-mode)))
     ("c++" ("C++" (used-mode . c++-mode))
      ("Verilog" (used-mode . verilog-mode)))
     ("Verilog" ("Verilog" (used-mode . verilog-mode)))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Noto Mono" :foundry "GOOG" :slant normal :weight regular :height 151 :width normal))))
